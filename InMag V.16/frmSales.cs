    ...
    public partial class frmSalesGST : Form
    {
        ...
        private void SearchGridLoad()
        {
            try
            {
                ...
                SearchGrid.Columns[16].Visible = false;
                SearchGrid.Columns[17].Visible = false;
                SearchGrid.Columns[18].Visible = false;
        ...
        private void taxCalc()
        {
            try
            {
                ...
                double rent = 0;
                if (txtRent.Text == "." || txtRent.Text.Trim() == "")
                    rent = 0;
                else
                    rent = Convert.ToDouble(txtRent.Text);

                double commission = 0;
                if (txtCommission.Text == "." || txtCommission.Text.Trim() == "")
                    commission = 0;
                else
                    commission = Convert.ToDouble(txtCommission.Text);

                double cooli = 0;
                if (txtCooli.Text == "." || txtCooli.Text.Trim() == "")
                    cooli = 0;
                else
                    cooli = Convert.ToDouble(txtCooli.Text);
                ...
                txtGrand.Text = ((Convert.ToDouble(txtBillTotal.Text == "" ? "0" : txtBillTotal.Text) + Convert.ToDouble(txtGST.Text == "" ? "0" : txtGST.Text)) - discount-cooli-rent-commission).ToString();
        ...
        private void txtRate_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                ...
                else
                {
                    ...
                    DataTable dt = (DataTable)Connections.Instance.ShowDataInGridView(query);
                    query = "select qty,Nos,Less,TotLess,kg from tblTemp where itemId='" + txtItems.Tag.ToString() + "'";
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        if (txtBillno.Tag == null)
                        {
                            if (txtItemcode.Tag == null)
                            {
                                ...
                                double newNos = Convert.ToDouble(txtNos.Text == "" ? "0" : txtNos.Text) + Convert.ToDouble(dt1.Rows[0][1].ToString());
                                double newless = Convert.ToDouble(txtLess.Text == "" ? "0" : txtLess.Text) + Convert.ToDouble(dt1.Rows[0][2].ToString());
                                double newTotless = Convert.ToDouble(txtTotLess.Text == "" ? "0" : txtTotLess.Text) + Convert.ToDouble(dt1.Rows[0][3].ToString());
                                double newKg = Convert.ToDouble(txtKg.Text == "" ? "0" : txtKg.Text) + Convert.ToDouble(dt1.Rows[0][4].ToString());
                                ...
                                if (Convert.ToDouble(dt.Rows[0][0].ToString()) < newQty)
                                {
                                    ...
                                    if (dialogResult == DialogResult.Yes)
                                        query = "update tblTemp set Qty='" + newQty + "',Nos='" + newNos + "',Less='" + newless + "',TotLess='" + newTotless + "',Kg='" + newKg + "',rate='" + Convert.ToDouble(txtRate.Text.Trim() == "" ? "0" : txtRate.Text) + "',total='" + newTotal + "' where itemId='" + txtItems.Tag.ToString() + "'";
                                }
                                else
                                    query = "update tblTemp set Qty='" + newQty + "',Nos='" + newNos + "',Less='" + newless + "',TotLess='" + newTotless + "',Kg='" + newKg + "',rate='" + Convert.ToDouble(txtRate.Text.Trim() == "" ? "0" : txtRate.Text) + "',total='" + newTotal + "' where itemId='" + txtItems.Tag.ToString() + "'";
                            }
                        ...
                        else
                        {
                            if (txtItemcode.Tag == null)
                            {
                                ...
                                query = "select qty,Nos,Less,TotLess,Kg from tblSaleTrans where itemId='" + txtItems.Tag.ToString() + "' and saleId='" + txtBillno.Tag.ToString() + "'";
        ...
        private void SearchGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            { 
                ...
                txtRent.Text = SearchGrid.Rows[e.RowIndex].Cells[16].Value.ToString();
                txtCooli.Text = SearchGrid.Rows[e.RowIndex].Cells[17].Value.ToString();
                txtCommission.Text = SearchGrid.Rows[e.RowIndex].Cells[18].Value.ToString();
                ...
                txtGST.Text = "0";
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        if (txtBillno.Tag == null)
                        {
                            ...
                            query = "insert into tblSales(BillNo,BillDate,areaId,custId,CBalance,GrandTotal,Cash,Discount,Balance,updated,Rent,Cooli,Commission" +
                                    ...
                                    "'" + Convert.ToDouble(txtRent.Text == "" ? "0" : txtRent.Text) + "',"+
                                    "'" + Convert.ToDouble(txtCooli.Text == "" ? "0" : txtCooli.Text) + "'," +
                                    "'" + Convert.ToDouble(txtCommission.Text == "" ? "0" : txtCommission.Text) + "'," +
                        ...
                        if (dialogResult == DialogResult.Yes)
                        {
                            ...
                            System.Data.DataColumn Rent = new System.Data.DataColumn("Rent", typeof(System.Decimal));
                            Rent.DefaultValue = txtRent.Text == "" ? "0" : txtRent.Text;
                            System.Data.DataColumn Cooli = new System.Data.DataColumn("Cooli", typeof(System.Decimal));
                            Cooli.DefaultValue = txtCooli.Text == "" ? "0" : txtCooli.Text;
                            System.Data.DataColumn Commission = new System.Data.DataColumn("Commission", typeof(System.Decimal));
                            Commission.DefaultValue = txtCommission.Text == "" ? "0" : txtCommission.Text;
                            ...
                            //dtCloned.Columns[14].DataType = typeof(Decimal);
                            //dtCloned.Columns[15].DataType = typeof(Decimal);
